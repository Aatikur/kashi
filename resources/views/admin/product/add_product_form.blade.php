    	    ...
    	    <div class="x_panel">
    	        ...
    	        <div>
    	            <div class="x_content">
    	            	...
    	            	{{ Form::open(['method' => 'post','route'=>'admin.insert_product' ,'enctype'=>'multipart/form-data']) }}
                        ...
                        <div class="well" style="overflow: auto" id="size_div">
                            <div class="form-row mb-3">                                
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input type="number" step="any" class="form-control" name="mrp"  value="{{ old('mrp') }}" placeholder="Enter MRP" required>
                                </div>

                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    <label for="price">Enter Price <span><b style="color: red"> * </b></span></label>
                                    <input type="number" step="any" class="form-control" name="price"  value="{{ old('price') }}" placeholder="Enter Price" required>
                                </div>
                        ...
                        <div class="well" style="overflow: auto">
                            <div class="form-row mb-10">
                                <div class="col-md-12 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <textarea class="form-control" name="description" id="description">{{ old('short_description') }}</textarea>
                                </div>
                            </div>
                        </div>
